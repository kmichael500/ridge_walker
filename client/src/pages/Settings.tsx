...
import {registerUser,getUserProfile, updateOneUserByID, getOneUserByID} from '../dataservice/authentication';
                  ...
                  <Col span={24}>
                    <Form.Item
                      ...
                      rules={[
                        ...
                        ({getFieldValue}) => ({
                          validator(rule, value) {
                            if (getFieldValue('password') === value || getFieldValue('password') === undefined) {
                              return Promise.resolve();
                            }
                            return Promise.reject(
                ...
                <Row>
                  <Col span={24}>
                    <Form.Item
                      ...
                      name="privateFields"
                      initialValue={Object.keys(this.state.user.privateFields).map((key)=>{
                        return this.state.user.privateFields[key] ? key : null
                    })}
                    ...
                    >
                      <Checkbox.Group
                        ...
                        defaultValue={Object.keys(this.state.user.privateFields).map((key)=>{
                            return this.state.user.privateFields[key] ? key : null
                        })}
                      />
                    </Form.Item>
