...
import { Drawer, List, Avatar, Divider, Col, Row, Tag, Typography, Space, Spin } from 'antd';
            ...
            return (
                <>
                    ...
                    <Row>
                        ...
                        <Divider />
                        <Col span={12}>
                        <DescriptionItem title="Email" content={<a href={"mailto:"+this.state.user.email}>{this.state.user.email}</a>}/>
                        </Col>
                        <Col span={12}>
                            <DescriptionItem title="Phone Number" content={<a href={"tel:"+this.state.user.phoneNumber}>{this.state.formattedPhoneNumber}</a>}/>
                        </Col>
                    </Row>
                    <Row>
                        <Col span={12}>
